...
import 'controller/main_rout_getx_controller.dart';

class MainRout extends StatefulWidget {
  final int? index;

  MainRout({this.index});

  @override
  State<MainRout> createState() => _MainRoutState();
}

class _MainRoutState extends State<MainRout> {
  //controller
  ...
  @override
  void initState() {
    // print("tutor - centerId : ${SharedPrefController().centerId}");
    if (widget.index != null) {
      _mainRoutGetxController.currentIndex = widget.index!;
    }
    super.initState();
  }
      ...
      builder: (controller) {
        return Scaffold(
          ...
          body: WillPopScope(
              ...
              child: controller.screens[_mainRoutGetxController.currentIndex]),
