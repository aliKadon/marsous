...
import 'package:marsous/screens/flex_lesson/recording_attendance_view.dart';

import 'package:marsous/widgets/student_widget/student_previous_lesson_item.dart';
            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => FlexPrevoiusLessonDetailsView(
